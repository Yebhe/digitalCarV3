    ...
    <div class="col-md-6">
      <div class="card p-4 shadow-lg bg-034078">
        ...
        <form @submit.prevent="loginUser" novalidate>
          ...
          <router-link
            to="/forgot-password"
            class="d-block mt-3 text-center text-white"
            aria-label="Mot de passe oublié ?"
          >
            Mot de passe oublié ?
          </router-link>
          </p>
          <p class="text-center text-white">Vous n'avez pas de compte, <router-link to="/signup" class="d-block mt-3 text-white" aria-label="Mot de passe oublié ?">inscrivez-vous</router-link></p>
        </form>
      </div>
    </div>
  </div>
